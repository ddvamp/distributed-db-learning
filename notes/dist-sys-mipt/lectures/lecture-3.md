...
Построенный в лекции 2 алгоритм называется **ABD (Attiya, Bar-Noy, Dolev)**. Он позволяет работать только с "одной ячейкой", т.е. с данными фиксированного объёма. Для наших целей его недостаточно
...
- read/write мало для транзакций (решим в лекции 11?)
- он не предусматривает реконфигурации (решим в [лекции 8](https://github.com/ddvamp/distributed-db-learning/blob/main/notes/dist-sys-mipt/lectures/lecture-8.md#реконфигурация))
